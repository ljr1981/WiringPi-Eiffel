...
feature -- Access
	...
	wiring_pi_version (major: TYPED_POINTER [INTEGER]; minor: TYPED_POINTER [INTEGER]) 
		do
	...
	pi_board_id (model: TYPED_POINTER [INTEGER]; rev: TYPED_POINTER [INTEGER]; mem: TYPED_POINTER [INTEGER]; maker: TYPED_POINTER [INTEGER]; overvolted: TYPED_POINTER [INTEGER]) 
		do
	...
	delay_microseconds (howlong: NATURAL)
		external
			"C inline use <wiringPi.h>"
		alias
			"[
...
feature -- Externals
	...
	c_wiring_pi_version (major: TYPED_POINTER [INTEGER]; minor: TYPED_POINTER [INTEGER])
		external
			"C inline use <wiringPi.h>"
		alias
			"[
	...
	c_pi_board_id (model: TYPED_POINTER [INTEGER]; rev: TYPED_POINTER [INTEGER]; mem: TYPED_POINTER [INTEGER]; maker: TYPED_POINTER [INTEGER]; overvolted: TYPED_POINTER [INTEGER])
		external
			"C inline use <wiringPi.h>"
		alias
			"[
